...
<head>
    ...
    <link rel="stylesheet" href="/Static/asset/layuiv1/css/layuiv2.css" media="all">
    <style>
        .layui-edge{
            display: block;
        }
...
<ul class="layui-nav" >
    ...
    <li class="layui-nav-item"><a target="_blank" href="javascript:void(0);">天明的博客</a></li>
    <li class="layui-nav-item"><a target="_blank" href="https://github.com/tianming01/EasySwooleChat">Github</a></li>

</ul>
<script type="text/javascript" src="http://apps.bdimg.com/libs/jquery/2.1.1/jquery.min.js"></script>
<script src="/Static/asset/layuiv1/layui.js"></script>
<script>
        var socket;
        var ping;
        ...
        layui.use('layim', function(layim){
            ...
            layim.config({
                ...
                ,chatLog: '/User/chatLog?token=' + storage.getItem("token") //聊天记录页面地址，若不开启，剔除该项即可
            });
            //监听自定义工具栏点击，以添加代码为例
            //建立websocket连接
            ...
            socket.onopen = function(){
                ...
                ping = setInterval(function () {
                    sendMessage(socket,'{"action":"ping"}');
                    console.log("ping...");
                },1000 * 60)
            };
            ...
            layim.on('sign', function(value){
                ...
                $.ajax({
                    url:"/User/updateSign?token=" + storage.getItem('token'),
                    type:"post",
                    data:{sign:value},
                    dataType:"json",
