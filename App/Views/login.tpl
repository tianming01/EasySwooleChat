...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Static/asset/layuiv2/css/layui.css" />
    <script type="text/javascript" src="http://apps.bdimg.com/libs/jquery/2.1.1/jquery.min.js"></script>
    <script type="text/javascript" src="/Static/asset/layuiv2/layui.js"></script>
</head>
<body>
