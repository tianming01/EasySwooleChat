            ...
            ei = {
                ...
                about: function() {
                    t.alert("版本： 0.1" +
                        ...
                        '<br>后端技术支持：easyswoole V3.3.7'+
                        '<br>作者：天明 <303831780@qq.com>'+
                        '<br>项目地址：<a href="https://github.com/tianming01/EasySwooleChat">https://github.com/tianming01/EasySwooleChat</a>'+
                        '<br>声明：<span style="color:red;">此项目仅供学习交流，请勿用作商业用途</span>', {
                        title: "关于 EasySwoole-Chat",
                        shade: !1
                    })
                },
                setSkin: function(i) {
